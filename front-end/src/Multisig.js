...
export default function Main (props) {
	...
	const [formState, setFormState] = useState({ threshold: 0, otherSigs: '', addressTo: '5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty', amount: 0 });
				...
				<Form.Field style={{ textAlign: 'left' }}>
					<TxButton
						...
						attrs={{
							palletRpc: 'multisig',
							callable: 'asMulti',
							inputParams: [threshold, otherSigs.split(' '), null, api.tx.balances.transfer(addressTo, amount), false, 54744580000],
